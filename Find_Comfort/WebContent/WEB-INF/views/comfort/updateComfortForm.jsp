...
<%-- 							<legend><h3>주변장소<%= 1 + i %></h3></legend> --%>
<!-- 							<div class="form__group field"> -->
<%-- 								<input type="text" class="form__field lg" placeholder="주변장소명" name="aroundName<%= 1 + i %>" id="aroundName<%= 1 + i %>" value="<%= aroundList.get(i).getAroundName() %>" required > --%>
<!-- 				  				<label for="aroundName1" class="form__label">주변장소명</label> -->
<!-- 							</div> -->
<!-- 							<div class="form__group field"> -->
<%-- 								<input type="text" class="form__field lg" placeholder="주변장소설명" name="aroundText<%= 1 + i %>" id="aroundText<%= 1 + i %>" value="<%= aroundList.get(i).getAroundText ()%>" required > --%>
<%-- 				  				<label for="aroundText<%= 1 + i %>" class="form__label">주변장소설명</label> --%>
<!-- 							</div> -->
<!-- 							<div class="form__group field"> -->
<%-- 								<input type="file" class="form__field lg" name="aroundImage<%= 1 + i %>" > --%>
...
<!-- 						<input type="button" class="btn btn-outline-primary"  onclick="cloneAround()" value ="+"> -->
<!-- 					</div> -->
<!-- 					<script> -->
...
<!-- 					</script> -->
<!--    			</div> -->
				<input type="hidden" name="roomNo" value="<%= comfort.getRoomNo() %>">
...
<div class="sideMove">
  <div class="side"> 
    <div class="side_link" id="side1">COMFORT 1/3</div>
    <div class="side_link" id="side2">COMFORT 2/3</div>
    <div class="side_link" id="side3">COMFORT 3/3</div>
